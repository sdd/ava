...
// Older AVA versions that do not use Kathryn don't handle globals very well.
// Use this so formatting output can be contrasted between versions.
const formatGlobals = !!require(process.env.AVA_PATH + '/package.json').dependencies.kathryn
